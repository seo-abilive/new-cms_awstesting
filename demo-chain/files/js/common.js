...
function rsvLink() {
	$('a').each(function(){
		if($(this).attr('data-sp-href')) {
			if(!$(this).attr('data-pc-href')) {
				var href = $(this).attr('href');
				$(this).attr('data-pc-href',href);
			}
			var hrefPc = $(this).attr('data-pc-href');
			var hrefSp = $(this).attr('data-sp-href');
			if(abi.sp) {
				$(this).attr('href',hrefSp);
			}else {
...
document.addEventListener("DOMContentLoaded", function(e) {
	...
	$doc.click(function(){
		if($('.js-accordion-hotel').is('.active')) {
			$('.js-accordion-hotel').removeClass('active').next('div').slideUp();
		}
	});
	$('.js-accordion-hotel').click(function(e){
		if($(this).parent().siblings().find('.st').is('.active')) {
			$(this).parent().siblings().find('.st').removeClass('active').next('div').slideUp();
		}
		e.stopPropagation();
	});
