$(function(){
	...
	// 施設情報取得
	var rsvSystem = $('.js-base_Form').data('rsv');
	var rsvId = $('.js-base_Form').data('id');
	var rsvSp = $('.js-base_Form').data('mobile-page');
	...
	// ホテル未選択時アラート
	// $formSearch.find('.box_parts').not('.box_htl').click(function(){
	// 	var hotelVal = $(this).closest('form').find('.js-selectHotel').find('input').val();
	// 	if(hotelVal == '') {
	// 		alert('ホテルを選択してください');
	// 	}
	// });	
	...
	var hotelName = $('.js-area').val();
	var $parentsForm = $('.js-area').parents('form');
