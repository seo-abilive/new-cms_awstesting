            ...
            <ul class="inn_news">
                ...
                <li>
                    <a href="<?php echo $link; ?>" target="<?php echo $target; ?>">
                        <div class="wrp_txt">
                            <div class="info">
                                <p class="dat"><?php echo (new \DateTime($news['date-input']))->format('Y.m.d') ?></p>
                                <?php if (!empty($news['categories'])) : ?>
                                    <ul class="cat">
                                        <?php foreach ($news['categories'] as $category) : ?>
                                            <li><?php echo $category['text-input']; ?></li>
                                        <?php endforeach; ?>
                                    </ul>
                                <?php endif; ?>
                            </div>
                            <p class="tit"><?php echo $news['text-input']; ?></p>
                            <span class="i"></span>
                        </div>
                        <?php if (!empty($news['thumbnail'])) : ?>
                            <p class="photo">
                                <img src="<?php echo $news['thumbnail']['file_url']; ?>" alt="<?php echo e($news['text-input']); ?>">
                            </p>
                        <?php endif; ?>
                    </a>
                </li>
