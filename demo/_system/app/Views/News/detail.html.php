...
<div class="box_arrow">
    <?php if ($sibLings['previous']) : ?>
        <p class="prev slick-arrow">
            <a href="<?php echo LOCATION . 'news/' . $sibLings['previous']['id'] . '/'; ?>">
    ...
    <p class="btn">
        <a href="<?php echo LOCATION . 'news/'; ?>">記事一覧<span class="view_pc-tab">に戻る</span></a>
    </p><!-- /.con_pager -->

    <?php if ($sibLings['next']) : ?>
        <p class="next slick-arrow">
            <a href="<?php echo LOCATION . 'news/' . $sibLings['next']['id'] . '/'; ?>">
